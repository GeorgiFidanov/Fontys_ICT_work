...
namespace Bakery
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            cbbBreadFilter.Items.Add("Show All");
        ...
        {
            if (cbbBreadFilter.SelectedItem == null || cbbBreadFilter.SelectedItem.ToString() == "Show All")
            {
                displayAll(bakery.GetAvailableSandwiches());
                MessageBox.Show("Displaying all sandwiches.");
            }
            else
            {
