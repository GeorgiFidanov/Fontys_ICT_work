...
# These are the codes for all the tasks in week 1 and 2, there are also some from week 3
def the_high_iq_game():
    players_number = int(input("Please enter a number lower than 10: "))
    if players_number >= 10:
        print("Cheater...")

    elif players_number == 9:
        print("That's tie.")

    else:
        print(f"{players_number + 1}!")
        print("I win!")
...
def guess_the_word(word):
    ...
    guess = input("Guess the word! You can try by guessing with only a letter or a whole word: ")
...
if __name__ == '__main__':
    ...
    print("Uncomment the task you want to test")
    # the_high_iq_game()
    # find_the_leap_year()
    # check_the_password()
    # find_the_classroom()
    # print_the_tallest_player()
    # guess_the_number_game(100)
    # inform_the_boss()
    # guess_the_word("banana")
    # check_if_letter_is_in()